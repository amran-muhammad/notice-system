    ...
    <div style="margin-top:20px;">
        ...
        <div class="d-f">
            ...
            <div class="md-m-l-33-percent card" style="width: 11rem;">
                <img v-if="imageEdit==false" class="photo card-img-top" :src="user.image ? user.image : 'images/avatar.png'" alt="Card image cap">
                <div v-else>
                    <label class="custom_label">Click to upload a picture
                        <input style="display:none" accept="image/*" type="file" @change="fileUpload" >
                    </label>
                    <img ondrop="fileUpload" class="photo card-img-top" :src="photo ? photo : 'images/avatar.png'" alt="Card image cap">
                </div>
                <div class="card-body">
